...
public class MsSqlServerDbContext : DbContext, IMsSqlServerDbContext
{
    private readonly ILoggerFactory _loggerFactory;

    private readonly AppOptions _appOptions;
    public MsSqlServerDbContext(ILoggerFactory loggerFactory, IOptions<AppOptions> settingWrapper)
    {
